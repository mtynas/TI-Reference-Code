...
#define UI_LCD_LINE_4 HAL_LCD_LINE_4
#define UI_LCD_LINE_5 HAL_LCD_LINE_5
#define UI_LCD_LINE_6 HAL_LCD_LINE_6
...
{
  char * line[6];
  char LineBuf[6][LCD_CC2538_PREFIX_COUNT + LCD_LINE_LENGTH + 1];
  uint8 i;
  uint8 *xad;
  ...
  LineBuf[4][LCD_CC2538_PREFIX_COUNT] = 0;
  LineBuf[5][LCD_CC2538_PREFIX_COUNT] = 0;

  line[0] = LineBuf[0] + LCD_CC2538_PREFIX_COUNT;
  line[1] = LineBuf[1] + LCD_CC2538_PREFIX_COUNT;
  line[2] = LineBuf[2] + LCD_CC2538_PREFIX_COUNT;
  line[3] = LineBuf[3] + LCD_CC2538_PREFIX_COUNT;
  line[4] = LineBuf[4] + LCD_CC2538_PREFIX_COUNT;
  line[5] = LineBuf[5] + LCD_CC2538_PREFIX_COUNT;
  ...
  else
  {
    ...
    switch (uiCurrentState)
    {
      ...
      case UI_STATE_INFO:
        ...
        {
        case DEV_HOLD:
			  uiConstStrCpy(line[4], "HOLD");
        	break;
        case DEV_INIT:
			  uiConstStrCpy(line[4], "INIT");
			  break;
        case DEV_NWK_DISC:
			  uiConstStrCpy(line[4], "NWK_DISC");
			  break;
        case DEV_NWK_JOINING:
			  uiConstStrCpy(line[4], "NWK_JOINING");
			  break;
        case DEV_NWK_SEC_REJOIN_CURR_CHANNEL:
			  uiConstStrCpy(line[4], "SEC_REJOIN_CURR");
			  break;
        case DEV_END_DEVICE_UNAUTH:
			  uiConstStrCpy(line[4], "DEVICE_UNAUTH");
			  break;
        case DEV_END_DEVICE:
			  uiConstStrCpy(line[4], "END_DEVICE");
			  break;
        case DEV_ROUTER:
			  uiConstStrCpy(line[4], "ROUTER");
			  break;
        case DEV_COORD_STARTING:
			  uiConstStrCpy(line[4], "COORD_STARTING");
			  break;
        case DEV_ZB_COORD:
			  uiConstStrCpy(line[4], "ZB_COORD");
			  break;
        case DEV_NWK_ORPHAN:
			  uiConstStrCpy(line[4], "NWK_ORPHAN");
			  break;
        case DEV_NWK_KA:
			  uiConstStrCpy(line[4], "NWK_KA");
			  break;
        case DEV_NWK_BACKOFF:
			  uiConstStrCpy(line[4], "NWK_BACKOFF");
			  break;
        case DEV_NWK_SEC_REJOIN_ALL_CHANNEL:
			  uiConstStrCpy(line[4], "SEC_REJOIN_ALL");
			  break;
        case DEV_NWK_TC_REJOIN_CURR_CHANNEL:
			  uiConstStrCpy(line[4], "TC_REJOIN_CURR");
			  break;
        case DEV_NWK_TC_REJOIN_ALL_CHANNEL:
			  uiConstStrCpy(line[4], "TC_REJOIN_ALL");
			  break;
        }
  ...
  HalLcdWriteString( line[3], UI_LCD_LINE_4 );
  HalLcdWriteString( line[4], UI_LCD_LINE_5 );
  HalLcdWriteString( line[5], UI_LCD_LINE_6 );
